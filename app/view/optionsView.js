  ...
  return (
    <div>
      ...
      <div onClick={handleNextView} className="grid grid-cols-4 gap-2 mt-2">
        {options.map((e) => {
          return (
            <div className="items-center p-4 text-center text-white transition-all border border-gray-300 rounded-md cursor-pointer hover:border-purple-950 hover:text-purple-950 text ">
              {e}
            </div>
          );
        })}
